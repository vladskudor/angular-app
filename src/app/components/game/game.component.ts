...
export class GameComponent implements OnInit {
  ...
  public moveCarComputer(): void{
    ...
    this.eventManager.addGlobalEventListener('window' , 'keyup.enter' , () => {
      ...
      this.testCarDrive1.style.marginLeft = this.speed1 + this.paramCarOne[0].speed / 100 + 'vw';
    });
    this.eventManager.addGlobalEventListener('window' , 'keyup.space' , () => {
      ...
      this.testCarDrive2.style.marginLeft =  + this.speed2 + this.paramCarTwo[0].speed / 100 + 'vw';
    });
  }
